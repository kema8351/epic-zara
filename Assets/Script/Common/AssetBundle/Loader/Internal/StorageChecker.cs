...
namespace Zara.Common.ExAssetBundle.Internal
{
    public class StorageChecker
    {
        ...
        public void Load(string assetBundleName, Action<LoaderResult> onFinished, bool forciblyDownload = false)
        {
            Load(new AssetBundleRecord(assetBundleName), onFinished, forciblyDownload);
        }
